...
set.api.key("AIzaSyC2gnvLvWF7eNpW3Vhplj6PAk1mByUJJn4")
...
## What's Next?
Now that we have our answer, what’s next to be done with the data? The next very useful operation to perform would be to create a readout of what Census Tracts have the strongest customer potentiality. This should be accompanied by a heat-map diagram split up by Census Tract.
